...
| **RoadTrip**         | *Tools for AFK-travelling over long distances.* Can display ETA & offers some helpful notification & auto-disconnect settings for travel.                                                                                                             |
| **StashBrander**     | *Automatically rename desired items in bulk when using anvils.*                                                                                                                                                                                       |
| **AdBlocker**        | *Blocks advertisers in chat.* Simple but effective, with options to automatically ignore advertisers, including death-message advertisers.                                                                                                            |
...
| **AutoMason**        | *Automates masonry interactions in the stonecutter.*                                                                                                                                                                                                  |
| **AutoSmith**        | *Automatically upgrades gear or trims armor sets when interacting with smithing tables.*                                                                                                                                                              |
| **Grinder**          | *Automatically grinds enchantments off of selected items in the grindstone.*                                                                                                                                                                          |
...
| **AutoDyeShulkers**  | *Automatically dye shulker boxes (or bundles!) a desired color in crafting grids.*                                                                                                                                                                    |
...
| **Ignore 2b2t.org Overlay**         | *Config setting to disable the 2b2t.org overlay messages that show up periodically when playing on 2b2t.* This also allows you to ignore arbitrary overlay messages by adding their patterns to the filter setting.                                                                                                                   |
...
| **Peek Ghost Items / Illegal Hats** | *Adds a setting to BetterTooltips which allows you to interact with items from the middle-click-open screen by left-clicking them.* These items are client-side only and will disappear when you try to click on them or open another container. They can however be equipped on your head (client-side) by right clicking with them. |
...
| **Game of Life HUD**                | *A purely for-fun HUD module which displays lifelike cellular automata simulations.* I use it like a screensaver while AFK travelling. **This module comes with a PHOTOSENSITIVITY WARNING: If you are sensitive to flashing lights or colors, please proceed with caution.**                                                         |
